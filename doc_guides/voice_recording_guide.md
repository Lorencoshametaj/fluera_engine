# 🎤 Fluera Engine — Voice Recording Integration Guide

How to enable voice recording in your app using the Fluera Engine SDK.
...
third-party audio library), implement `FlueraVoiceRecordingProvider`:

```dart
import 'package:fluera_engine/fluera_engine.dart';

class MyRecordingProvider implements FlueraVoiceRecordingProvider {
  @override
