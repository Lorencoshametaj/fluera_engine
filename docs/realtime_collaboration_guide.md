...
> Enterprise-grade live multi-user canvas editing for Nebula Engine.
...
## Implementing `NebulaRealtimeAdapter`
...
```dart
class FirebaseRealtimeAdapter implements NebulaRealtimeAdapter {
