    ...
    private fun loadModule(ctx: Context, filename: String): Module? {
        return try {
            ...
            val assetPaths = listOf(
                "flutter_assets/packages/nebula_engine/assets/models/pix2tex/$filename",
    ...
    private fun loadVocab(ctx: Context) {
        try {
            val vocabPaths = listOf(
                "flutter_assets/packages/nebula_engine/assets/models/pix2tex/vocab.json",
            ...
            val configPaths = listOf(
                "flutter_assets/packages/nebula_engine/assets/models/pix2tex/config.json",
