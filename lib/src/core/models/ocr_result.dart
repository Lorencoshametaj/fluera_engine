...
class OcrPageResult {
    ...
    for (final block in blocks) {
      ...
      rects.add(
        PdfTextRect(
          ...
          charPositions: _computeProportionalPositions(block.text),
        ),
      );
  ...
  /// Compute proportional character positions within a block's bounding box
  /// using standard Latin font metrics. This vastly improves highlight
  /// precision compared to uniform subdivision (which fails for mixed-width
  /// characters like "i", "l", "w", "m").
  static List<double>? _computeProportionalPositions(String text) {
    if (text.isEmpty) return null;
    final len = text.length;
    final positions = List<double>.filled(len + 1, 0.0);
    final weights = List<double>.filled(len, 0.0);
    double totalWeight = 0;

    for (int i = 0; i < len; i++) {
      final code = text.codeUnitAt(i);
      final w = _latinWidths[code] ?? 600.0;
      weights[i] = w;
      totalWeight += w;
    }
    ...
    double current = 0;
    for (int i = 0; i < len; i++) {
      positions[i] = current / totalWeight;
      current += weights[i];
    }
    positions[len] = 1.0;
    return positions;
  ...
  /// Required for accurate proportional highlight subdivision of OCR blocks.
  static const _latinWidths = <int, double>{
    ...
    174: 737, 176: 400, 177: 584, 178: 333, 179: 333, 180: 333, 181: 556,
    183: 278, 184: 333, 185: 333, 186: 365, 187: 556, 191: 611, 192: 667,
    193: 667, 194: 667, 195: 667, 196: 667, 197: 667, 198: 1000, 199: 722,
    200: 667, 201: 667, 202: 667, 203: 667, 204: 278, 205: 278, 206: 278,
    207: 278, 208: 722, 209: 722, 210: 778, 211: 778, 212: 778, 213: 778,
    214: 778, 216: 778, 217: 722, 218: 722, 219: 722, 220: 722, 221: 667,
    ...
    244: 556, 245: 556, 246: 556, 248: 611, 249: 556, 250: 556, 251: 556,
    252: 556, 253: 500, 255: 500,
  };
