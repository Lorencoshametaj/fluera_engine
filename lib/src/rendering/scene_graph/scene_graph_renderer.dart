...
class SceneGraphRenderer {
  ...
  /// Render a section. **v16:** no chrome is drawn — no shadow, no
  /// background, no grid, no border, no label. The section survives in
  /// legacy canvas payloads as a silent [GroupNode] carrier; only its
  /// children are rendered. See [SpatialBookmark] for the replacement
