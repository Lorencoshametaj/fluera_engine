...
// ============================================================================
// OIL PAINT SHADER RENDERER — GPU impasto texture + directional streaks
// ============================================================================

extension ShaderOilPaintRenderer on ShaderBrushService {
  /// Render oil paint stroke with GPU impasto texture and directional smear.
  void renderOilPaintPro(
    Canvas canvas,
    List<dynamic> points,
    Color color,
    double baseWidth, {
    ...
    for (int k = 0; k < offsets.length - 1; k++) {
      ...
      final w1 = oilWidth * (0.6 + press * 0.4);
      final w2 = oilWidth * (0.6 + getPressure(points[k + 1]) * 0.4);
