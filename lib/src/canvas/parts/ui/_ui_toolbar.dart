        ...
        return RepaintBoundary(
          child: ProfessionalCanvasToolbar(
            ...
            callbacks: ToolbarCallbacks(
              ...
              // ── Design ───────────────────────────────────────────────────────
              onPrototypePlay: () => startPrototypePreview(context),
              onFlowLinkAdd: () => addFlowLink(context),
              onAnimationTimeline: () => showAnimationTimeline(context),
              onSmartAnimate: () => enableSmartAnimate(context),
              onInspectToggle: _toggleInspectMode,
              onCodeGen: _showCodeGenerator,
              onRedlineToggle: _toggleRedlineOverlay,
              onBreakpointSelect: (bp) => showBreakpointPicker(context, bp),
