...
class FlueraLocalizationsJa extends FlueraLocalizations {
  FlueraLocalizationsJa([String locale = 'ja']) : super(locale);
  ...
  @override
  String get branchExplorer_emptyTitle => 'まだ代替案はありません';

  @override
  String get branchExplorer_emptyBody =>
      'Time Travel 中に過去の瞬間を選び、「代替案を試す」をタップすると、作業を失わずに別のアプローチを試せます。';

  @override
  String get branchExplorer_primaryBranch => 'オリジナル';

  @override
  String get branchExplorer_main => 'オリジナル';

  @override
  String get branchExplorer_parent => '派生元';

  @override
  String get branchExplorer_active => '現在地';

  @override
  String get branchExplorer_new => '新しい代替案';

  @override
  String get branchExplorer_rename => '名前を変更';

  @override
  String get branchExplorer_renameBranch => '代替案の名前を変更';

  @override
  String get branchExplorer_editDescription => '説明を編集';

  @override
  String get branchExplorer_branchDescription => '代替案の説明';

  @override
  String get branchExplorer_duplicate => '新しい代替案にコピー';

  @override
  String get branchExplorer_delete => 'アーカイブ';

  @override
  String get branchExplorer_deleteForever => '完全にアーカイブ';

  @override
  String get branchExplorer_merge => 'オリジナルを置き換える';

  @override
  String get branchExplorer_deleteAfterMerge => '置き換え後にこの代替案をアーカイブ';

  @override
  String get branchExplorer_cancel => 'キャンセル';

  @override
  String get branchExplorer_save => '保存';

  @override
  String get branchExplorer_branchNameHint => '代替案の名前';

  @override
  String get branchExplorer_warningStrokes => 'すべての描画とストローク';

  @override
  String get branchExplorer_warningSnapshots => 'キャンバスのスナップショット';

  @override
  String get branchExplorer_title => '試した代替案';

  @override
  String get branchExplorer_mainCanvasLabel => 'オリジナル';

  @override
  String get branchExplorer_replaceConfirmTitle => 'オリジナルをこの代替案で置き換えますか？';

  @override
  String branchExplorer_replaceConfirmBody(String name) {
    return 'オリジナルは「$name」の内容で置き換えられます。この操作は取り消せません。';
  }
  ...
  String get branchExplorer_archiveConfirmBody =>
      'この代替案はリストから削除されます。オリジナルには影響しません。';

  @override
  String get branchExplorer_archiveWithChildren => 'サブ代替案もまとめてアーカイブされます。';

  @override
  String get branchExplorer_descriptionHint => 'なぜこの代替案を試していますか？';

  @override
  String get branchExplorer_youAreOnActiveWarning => '現在この代替案にいます。オリジナルに戻されます。';

  @override
  String get branchExplorer_timeTravelHistory => 'Time Travel の履歴';

  @override
  String get branchExplorer_subBranchesCascade => 'サブ代替案（連鎖）';

  @override
  String get checkpoint_title => 'マイチェックポイント';

  @override
  String get checkpoint_emptyTitle => 'まだチェックポイントはありません';

  @override
  String get checkpoint_emptyBody => 'チェックポイントを保存してこの瞬間をしおりに。いつでもここに戻れます。';

  @override
  String get checkpoint_saveTitle => 'チェックポイントを保存';
  ...
  @override
  String get checkpoint_restore => '復元';

  @override
  String get checkpoint_archive => 'アーカイブ';

  @override
  String get checkpoint_nameHint => 'チェックポイント名…';

  @override
  String checkpoint_counterFree(int used, int max) {
    return '使用済みチェックポイント: このキャンバスで $used/$max';
  }

  @override
  String get checkpoint_limitReachedTitle => 'Free の上限に達しました';

  @override
  String get checkpoint_limitReachedBody =>
      'Free はキャンバスごとに3つのチェックポイントを含みます。Plus は月額 €5.99 ですべてアンロックします — または既存のチェックポイントをアーカイブして空きを作りましょう。';

  @override
  String get checkpoint_upgradeToPlus => 'Plus にアップグレード';

  @override
  String get checkpoint_archiveExisting => '既存のチェックポイントをアーカイブ';

  @override
  String get timeTravelMenu_title => '履歴';

  @override
  String get timeTravelMenu_saveCheckpoint => 'ここにチェックポイントを保存';

  @override
  String get timeTravelMenu_viewCheckpoints => 'マイチェックポイントを表示';

  @override
  String get timeTravelMenu_exploreAlternative => 'ここから代替案を試す';

  @override
  String get timeTravelMenu_viewAlternatives => '試した代替案を表示';

  @override
  String get advancedMode_mergeToggleTitle => '高度なマージオプションを表示';

  @override
  String get advancedMode_mergeToggleSubtitle =>
      '代替案にクラシックなマージ UI を追加します。git スタイルのブランチに慣れた上級ユーザー向け。';
  ...
  @override
  String get versionHistory_saveVersion => 'チェックポイントを保存';

  @override
  String get versionHistory_saveVersionTitle => 'チェックポイントを保存';

  @override
  String get versionHistory_noVersions => 'まだチェックポイントはありません';

  @override
  String get versionHistory_cancel => 'キャンセル';

  @override
  String get versionHistory_save => '保存';

  @override
  String get versionHistory_restore => '復元';

  @override
  String get versionHistory_delete => 'アーカイブ';
