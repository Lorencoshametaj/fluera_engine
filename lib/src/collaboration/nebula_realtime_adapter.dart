...
// It follows the same adapter pattern as NebulaCloudStorageAdapter — the host
...
/// ```dart
/// class SupabaseRealtimeAdapter implements NebulaRealtimeAdapter {
...
/// }
/// ```
abstract class NebulaRealtimeAdapter {
...
// =============================================================================
// ⚙️ NEBULA REALTIME ENGINE — Internal orchestrator
//
// Manages:
...
class NebulaRealtimeEngine {
  final NebulaRealtimeAdapter _adapter;
  ...
  NebulaRealtimeEngine({
    required NebulaRealtimeAdapter adapter,
