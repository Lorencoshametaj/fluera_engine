// MetalStrokeRenderer.swift — Pure Metal live stroke renderer for macOS
// Renders live strokes as triangles with round caps + MSAA 4x
// Adapted from iOS version — uses .private instead of .memoryless for MSAA storage
...
class MetalStrokeRenderer {
    ...
    private func createRenderTargets() -> Bool {
        ...
        msaaDesc.storageMode = .private  // macOS: .private (no .memoryless on discrete GPUs)
